 ...
 */
// const buttonHandler = require('../routes/controller').buttonHandler;
...
function loadROM(arraybuffer) {
  ...
  switch (gb.getAddress(0x0147)) {
    case 0:
      document.getElementById('cartridge').innerHTML = 'ROM ONLY';
      break;
    case 1:
      document.getElementById('cartridge').innerHTML = 'MBC1';
      break;
    case 2:
      document.getElementById('cartridge').innerHTML = 'MBC1+RAM';
      break;
    case 3:
      document.getElementById('cartridge').innerHTML = 'MBC1+RAM+BATTERY';
      break;
    case 5:
      document.getElementById('cartridge').innerHTML = 'MBC2';
      break;
    case 6:
      document.getElementById('cartridge').innerHTML = 'MBC2+BATTERY';
      break;
    case 8:
      document.getElementById('cartridge').innerHTML = 'ROM+RAM';
      break;
    case 9:
      document.getElementById('cartridge').innerHTML = 'ROM+RAM+BATTERY';
      break;
    default:
      document.getElementById('cartridge').innerHTML =
        'Unknown (' + gb.getAddress(0x0147) + ')';
      break;
  }
  document.getElementById('cartridge').innerHTML +=
    '<br/>' + 2 * Math.pow(2, gb.getAddress(0x0148)) * 16 + 'KB ROM';
  switch (gb.getAddress(0x0149)) {
    case 0:
      document.getElementById('cartridge').innerHTML += ' - No RAM';
      break;
    case 1:
      document.getElementById('cartridge').innerHTML += ' - 2 KB RAM';
      break;
    case 2:
      document.getElementById('cartridge').innerHTML += ' - 8 KB RAM';
      break;
    case 3:
      document.getElementById('cartridge').innerHTML += ' - 32 KB RAM';
      break;
  }
...
function deleteCartridgeRam() {
  if (
    window.confirm(
      '¿Estás seguro de que quieres eliminar tu partida guardada y reiniciar el juego?'
    )
  ) {
